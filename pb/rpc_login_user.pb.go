...
type LoginUserResponse struct {
	...
	RefresTokenExpiresAt *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=refres_token_expires_at,json=refresTokenExpiresAt,proto3" json:"refres_token_expires_at,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *LoginUserResponse) GetRefresTokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.RefresTokenExpiresAt
	}
	return nil
}
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\bpassword\x18\x04 \x01(\tR\bpassword\"\xbe\x02\n" +
	...
	"\x17access_token_expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x14accessTokenExpiresAt\x12Q\n" +
	"\x17refres_token_expires_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x14refresTokenExpiresAtB%Z#github.com/matodrobec/simplebank/pbb\x06proto3"
...
var file_rpc_login_user_proto_depIdxs = []int32{
	...
	3, // 2: pb.LoginUserResponse.refres_token_expires_at:type_name -> google.protobuf.Timestamp
