...
type SimpleBankClient interface {
	...
	VerifyEmail(ctx context.Context, in *VerifyEamilRequest, opts ...grpc.CallOption) (*VerifyEamilResponse, error)
}
...
func (c *simpleBankClient) VerifyEmail(ctx context.Context, in *VerifyEamilRequest, opts ...grpc.CallOption) (*VerifyEamilResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyEamilResponse)
...
type SimpleBankServer interface {
	...
	VerifyEmail(context.Context, *VerifyEamilRequest) (*VerifyEamilResponse, error)
...
func (UnimplementedSimpleBankServer) VerifyEmail(context.Context, *VerifyEamilRequest) (*VerifyEamilResponse, error) {
...
func _SimpleBank_VerifyEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).VerifyEmail(ctx, req.(*VerifyEamilRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SimpleBank_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "service_simle_bank.proto",
}
