...
func (x *VerifyEamilRequest) Reset() {
	*x = VerifyEamilRequest{}
	mi := &file_rpc_verify_email_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VerifyEamilRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerifyEamilRequest) ProtoMessage() {}

func (x *VerifyEamilRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_verify_email_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use VerifyEamilRequest.ProtoReflect.Descriptor instead.
func (*VerifyEamilRequest) Descriptor() ([]byte, []int) {
	return file_rpc_verify_email_proto_rawDescGZIP(), []int{0}
}

func (x *VerifyEamilRequest) GetEmailId() int64 {
	if x != nil {
		return x.EmailId
	}
	return 0
...
func (x *VerifyEamilRequest) GetSecretCode() string {
	if x != nil {
		return x.SecretCode
	}
	return ""
...
type VerifyEamilResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *VerifyEamilResponse) Reset() {
	*x = VerifyEamilResponse{}
	mi := &file_rpc_verify_email_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VerifyEamilResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerifyEamilResponse) ProtoMessage() {}

func (x *VerifyEamilResponse) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_verify_email_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VerifyEamilResponse.ProtoReflect.Descriptor instead.
func (*VerifyEamilResponse) Descriptor() ([]byte, []int) {
	return file_rpc_verify_email_proto_rawDescGZIP(), []int{1}
}

func (x *VerifyEamilResponse) GetIsVerified() bool {
	if x != nil {
		return x.IsVerified
	}
	return false
...
const file_rpc_verify_email_proto_rawDesc = "" +
	...
	"\x12VerifyEamilRequest\x12\x19\n" +
	"\bemail_id\x18\x01 \x01(\x03R\aemailId\x12\x1f\n" +
	"\vsecret_code\x18\x02 \x01(\tR\n" +
	"secretCode\"6\n" +
	"\x13VerifyEamilResponse\x12\x1f\n" +
	"\vis_verified\x18\x01 \x01(\bR\n" +
	"isVerifiedB%Z#github.com/matodrobec/simplebank/pbb\x06proto3"
...
var file_rpc_verify_email_proto_goTypes = []any{
	(*VerifyEamilRequest)(nil),  // 0: pb.VerifyEamilRequest
	(*VerifyEamilResponse)(nil), // 1: pb.VerifyEamilResponse
}
